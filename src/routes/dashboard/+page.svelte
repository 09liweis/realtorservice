<script lang="ts">
  ...
  import { DASHBOARD_CLEANINGS_URL, DASHBOARD_LISTINGS_URL, DASHBOARD_OFFERS_URL, DASHBOARD_PROFILE_URL, DASHBOARD_SOCIAL_MEDIA_SERVICES_URL, DASHBOARD_STAGINGS_URL, DASHBOARD_VIDEO_SERVICES_URL, getPageTitle } from '$lib/types/constant';
...
<div class="space-y-8">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <ServiceStatsCard 
      ...
      color="indigo"
      loading={loading}
      link={DASHBOARD_VIDEO_SERVICES_URL}
    >
      <div class="text-sm text-gray-600 mt-1">
    ...
    <ServiceStatsCard 
      ...
      color="pink"
      loading={loading}
      link={DASHBOARD_SOCIAL_MEDIA_SERVICES_URL}
    >
      <div class="text-sm text-gray-600 mt-1">
