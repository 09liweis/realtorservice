<script lang="ts">
  ...
  import { DASHBOARD_CLEANINGS_URL, DASHBOARD_LISTINGS_URL, DASHBOARD_OFFERS_URL, DASHBOARD_SOCIAL_MEDIA_SERVICES_URL, DASHBOARD_STAGINGS_URL, DASHBOARD_VIDEO_SERVICES_URL, getPageTitle } from '$lib/types/constant';
