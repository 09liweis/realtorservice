		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
			<div>
				<h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
					Why Choose Realtor Service?
				</h2>
				<p class="text-lg text-gray-600 mb-8">
					With over a decade of experience in the real estate industry, we've built our reputation on delivering exceptional results and personalized service. Our comprehensive approach ensures every aspect of your real estate transaction is handled with expertise and care.
				</p>
				...
				<div class="space-y-6">
					<div class="flex items-start space-x-4">
						...
						<div>
							...
							<p class="text-gray-600">Over 500 successful transactions with an average of 95% of asking price achieved.</p>
						</div>
					</div>
					...
					<div class="flex items-start space-x-4">
						...
						<div>
							...
							<p class="text-gray-600">Licensed professionals with specialized expertise in staging, marketing, and negotiation.</p>
						</div>
					</div>
					...
					<div class="flex items-start space-x-4">
						...
						<div>
							...
							<p class="text-gray-600">Round-the-clock availability to address your questions and concerns throughout the process.</p>
						</div>
					</div>
				</div>
			</div>
